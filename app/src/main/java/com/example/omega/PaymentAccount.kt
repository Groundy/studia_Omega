...
class PaymentAccount() {
    ...
    private var accountDescription : String? = null
    ...
    constructor(jsonObjectResponse: JSONObject) : this() {
        try {
	        ...
	        val ownerNameJsonArray = accountDetailsObj.getJSONObject(NameAdressObj.text).getJSONArray(OtherJsonFields.Value.text)
